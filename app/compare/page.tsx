              ...
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={(() => {
                  const chartData = trajectoryData.map(d => {
                    ...
                    return {
                      year: d.year,
                      backlogGW: isFinite(backlogGW) ? backlogGW : null,
                      timeToPowerYears: isFinite(timeToPowerYears) ? timeToPowerYears : null,
                      demandNewGW: isFinite(demandNewGW) ? demandNewGW : null,
                      buildRateGWyr: isFinite(buildRateGWyr) ? buildRateGWyr : null,
                      capacityGW: isFinite(capacityGW) ? capacityGW : null,
                      demandGW: isFinite(demandGW) ? demandGW : null,
                      pipelineGW: isFinite(pipelineGW) ? pipelineGW : null,
                    };
                  });
                  ...
                  <Tooltip 
                    formatter={(value: any, name: any) => {
                      ...
                      if (name === 'timeToPowerYears') {
                        return [`${numValue.toFixed(2)} years`, 'Time to Power'];
                      }
                      return [`${numValue.toFixed(2)} GW`, name || ''];
                    } as any}
